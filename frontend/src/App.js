    ...
    <div className="App">
      <header className="App-header">
        <div className = "linkContainer">
          <Link to ="/spotify" className = "spotifyLogo"><img src = {spotifyLogo} alt = "spotify_logo"/></Link>
          <Link to ="/youtube" className = "youtubeLogo"><img src = {youtubeLogo} alt = "spotify_logo"/></Link>
        {/* <Logo /> */}
        </div>
